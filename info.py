...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/ur_movie_bot')
...
URL = "https://imperial-rubia-kissuxbots-007df606.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://imperial-rubia-kissuxbots-007df606.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://imperial-rubia-kissuxbots-007df606.koyeb.app/".format(FQDN)
else:
    URL = "https://imperial-rubia-kissuxbots-007df606.koyeb.app/".format(FQDN)
