...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/pwlived')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/kissu123456')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'kissu123456')
...
URL = "https://kissu123456-a76b42283d73.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://kissu123456-a76b42283d73.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://kissu123456-a76b42283d73.herokuapp.com/".format(FQDN)
else:
    URL = "https://kissu123456-a76b42283d73.herokuapp.com/".format(FQDN)
